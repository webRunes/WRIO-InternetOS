...
namespace WRIO.Controllers
{
    public class ProfileController : CustomControllerBase
    {
        ...
        //{
        //    const string returnUrl = "http://localhost:3927/profile/FaceBookCallback";
        //    var fbAuth = new FacebookAuthorizer();
        //    fbAuth.ClientId = "550557608347044";
        //    fbAuth.Scope = "user_work_history";//,friends_work_history,publish_stream,read_friendlists";
        //    fbAuth.RedirectUri = "http://localhost:3929/Profile/FaceBookCallback";
        ...
        //    var fbAuth = new FacebookAuthorizer();
        //    fbAuth.ClientId = "550557608347044";
        //    fbAuth.ClientSecret = "bde89d3fe83a73d2bc44dbdceb3c3794";
        //    fbAuth.RedirectUri = "http://localhost:3929/Profile/FaceBookCallback";
        //    var response = fbAuth.GetAuthorizationResponse(code);
        //    var client = new FacebookClient();
        //    client.Response = response;
        //    Dictionary<string, object> me = OAuthClientUtils.JsonToDictionary(client.Me());
        //    JsonResult result = Json(me);

        //   // Profile.UserService.LoginViaOauth(OAuthProvider.FaceBook, result, accesToken);

        //    Profile.LoginViaOauth(OAuthProvider.FaceBook, result, response);
