...
aps.controller('PlusCtrl', ['$scope', '$rootScope', 'AppsService', '$state', 'userAppSrv', 'paginationService', 'loginService',
    function ($scope, $rootScope, appTicketsService, $state, userAppsService, paginationService, loginService) {
        $scope.apps = [];
        $scope.currApp = {};
        //----pagination
        $scope.page = 1;
