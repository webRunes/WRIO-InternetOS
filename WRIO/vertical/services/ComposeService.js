...
//                });
        ...
        var getComposeEmpty = function(hubTag) {
            return {
                ...
                Title: '',
                Description: '',
                Picture: '/vertical/img/no-photo.png',
                HubTag: hubTag,
        ...
        var CalculatePostData = function(ind, callBack) {
            ...
            composes[ind].Picture='/vertical/img/no-photo.png';
        ...
        var FacebookContent=function(ind,callBack){
            ...
            var userId='';
            composes[ind].Picture='/vertical/img/facebook.png';
            composes[ind].PostContent = composes[ind].URL;
        ...
        var GoogleContent=function(ind,callBack){
            composes[ind].Picture='/vertical/img/google.png';
        ...
        var TwitterContent=function(ind,callBack){
            composes[ind].Picture='/vertical/img/twitter.png';
