    ...
    tour.addSteps([
      {
          ...
          content: "Пожалуйста, выберите интересующую вас тему.<ul class='nav nav-pills nav-stacked'><li><a href='conversation-plus.js'>Хочу продолжить знакомство с проектом. Тема на твое усмотрение</a></li><li><a href='conversation-webrunes.js'>Расскажи о webRunes</a></li><li><a href='conversation-wrio.js'>Что представляет из себя платформа WRIO?</a></li></ul><ul class='nav nav-pills nav-stacked'><li><a href='conversation-archive.js'>Hot actions<span class='pull-right label label-warning'>11</span></a></li><li><a href='conversation-archive.js'>Пожалуйста, открой страницу с архивами наших бесед</a></li></ul>"
      }
    ]);
