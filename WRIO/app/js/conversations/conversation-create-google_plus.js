    ...
    tour.addSteps([
      {
          ...
          element: ".step0",
          placement: "bottom",
          title: 'Create Google Plus post',
          content: 'Откройте Google Plus и найдите в правом верхнем углу заинтересовавшего вас поста иконку и кликнете по ней.<div class="col-xs-12"><img src="img/conversations/conversation-create-google_plus-1.png" /></div><div class="col-xs-12">После чего выберите "Embed post", откроется окно где вы сможете скопировать необходимый код</div><div class="col-xs-12"><img src="img/conversations/conversation-create-google_plus-2.png" /></div><div class="col-xs-12">Затем вставьте его в указанное поле и нажмите кнопку "Submit"</div><ul class="nav nav-pills nav-stacked"><li><a href="#">IA, пожалуйста, вставь любой пост для примера</a></li><li><a href="#">Все понятно! [назад]</a></li></ul>'
      }
    ]);
