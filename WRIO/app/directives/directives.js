...
aps.directive('appTicket',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/app-ticket.html'
    };
});
aps.directive('hubTicket',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/hub-ticket.html'
    };
});
aps.directive('postTicket',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/post-ticket.html'
    };
});
aps.directive('postWidget',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/post-widget.html'
    };
});
...
aps.directive('composeWidget',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/compose-widget.html'
    };
});
aps.directive('paginationFor',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/pagination-for.html'
    };
});
...
aps.directive('hubWidget',function () {
    return {
        restrict: 'A',
        templateUrl: '/app/templates/hub-widget.html',
        scope:{},
