    ...
    return (
        <div style={styles.linkTitleInputContainer}>
            ...
            >
                ...
                { showTitle && <div className="form-group">
                ...
                {showDescription && <div className="form-group">
                ...
                <div className="form-group pull-right">
                    {isEditLink ? (<button className="btn btn-danger btn-sm"
                                           onClick={e => onRemoveLink(linkEntityKey)}>
                        <span className="glyphicon glyphicon-trash"></span>Remove</button>) : null}
