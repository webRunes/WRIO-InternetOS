...
const CommentEnabler = ({isChecked,onCheck}) =>  {
    ...
    return (
        <div className="form-group">
            <label htmlFor="id-Comment" className="col-xs-6 col-sm-4 col-md-3 control-label">
            ...
            <div className="col-xs-6 col-sm-4 col-md-4">
                <div className="togglebutton">
                    <label>
                        <input name="isChecked" type="checkbox" checked={isChecked} onChange={handleInputChange} />
