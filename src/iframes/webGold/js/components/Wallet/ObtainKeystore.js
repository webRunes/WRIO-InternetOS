  ...
  return (
    <div className="form-horizontal">
      ...
      <div className="form-group form-inline">
        <label
          for="id-Passphrase"
          className="col-xs-12 col-sm-4 col-md-3 control-label"
        >
          12 word seed
        </label>
      ...
      <div className="col-xs-12">
        <a onClick={backCallback} className="btn btn-default">
        ...
        <div className="pull-right">
          <a
            ...
            onClick={() => forwardCallback(input.value)}
          >
...
export default class ObtainKeystore extends React.Component {
  ...
  async verify(seed) {
    ...
    if (!lightwallet.keystore.isSeedValid(seed)) {
      this.setState({
        error:
          "You've entered invalid seed. Your seed should be 12 words separated by spaces."
      });
    } else {
