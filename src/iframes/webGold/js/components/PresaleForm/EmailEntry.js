  ...
  render() {
    ...
    return (
      <div className="form-conrol">
        <label htmlFor="email" className="col-sm-4 col-md-3 control-label">
          Email
        </label>
        ...
        <br />
        <label htmlFor="emailcopy" className="col-sm-4 col-md-3 control-label">
          Repeat email
        </label>
        <div className={cls(this.state.emailInvalid)}>
          <input
