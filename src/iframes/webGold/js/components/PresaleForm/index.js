      ...
      <form name="presaleForm" onSubmit={this.addFunds.bind(this)}>
        {this.state.stage == 0 && (
          <div className="well enable-comment">
            ...
            <p>
              Press "Create Wallet" to get your first crypto-wallet that will
              open a door into the world of financial independence. No control,
              ID or verification will be required of you.
            </p>
            <br />
            <a
            ...
            >
              <span className="glyphicon glyphicon-ok-sign" />Create wallet
            </a>
          </div>
        )}
        ...
        {this.state.stage == 1 && (
          <div className="col-xs-12">
            <div className="col-xs-12 col-sm-3 col-md-3 col-lg-2">
              <label className="control-label">Prove you're not a robot</label>
            </div>
            <div id="googleRecaptcha" className="g-recaptcha" />
          </div>
        )}
            ...
            <div className="col-xs-12">
              <div className="pull-right">
                <button className="btn btn-success">
                  <span className="glyphicon glyphicon-thumbs-up" />Continue
                </button>
              </div>
            </div>
          </div>
