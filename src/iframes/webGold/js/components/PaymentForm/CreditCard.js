      ...
      <div>
        <div className="form-horizontal col-xs-12">
          <div className="col-xs-12 col-sm-3 col-md-3 col-lg-2">
            <label className="col-sm-12 control-label" htmlFor="creditCard">
              Credit Card
            </label>
          </div>
        ...
        <div className="form-horizontal form-group col-xs-3 col-sm-12">
          <div className="col-xs-12 col-sm-3 col-md-3 col-lg-2">
            <label className="col-sm-12 control-label" htmlFor="month">
              Month
            </label>
          </div>
        ...
        <div className="form-horizontal form-group col-xs-12">
          <div className="col-xs-12 col-sm-3 col-md-3 col-lg-2">
            <label className="col-sm-12 control-label" htmlFor="cvv">
              CVV
            </label>
          </div>
          <div className="col-xs-12 col-sm-4 col-md-4 col-lg-3">
