    ...
    render() {
        ...
        return (<div>
            <div
                ...
                {insuffientFunds && <div className="help-block">
                    <span>Insufficient funds</span>
                </div>}
            </div>
            <div className="form-group send-comment-form-donation col-xs-12 col-sm-6 col-md-4 col-lg-7">
                <div className="input-group input-group-sm">
                    <span className="input-group-addon twitter-limit">{this.props.left.title}</span>
                    <input ref="title"
                           name="tweet_title"
                           className="form-control"
                           maxLength={TITLE_LENGTH}
                           placeholder={`Title, hashtags or mentions. Max ${TITLE_LENGTH} characters`} type="text"
            ...
            <div className="form-group send-comment-form col-xs-12">
                        <textarea maxLength={COMMENT_LENGTH}
                                  rows="3"
                                  className="form-control"
