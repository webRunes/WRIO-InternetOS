...
test('should export save url for given wrioID and path', () => {
    expect(getSaveUrl('1234567890','sillyfolder/sillyfile.html')).toEqual('https://wr.io/1234567890/sillyfolder/sillyfile.html')
});
...
test('should edit existing document correctly',() => {
    const reducer = require('./publish').default;
    const s1 = reducer(undefined,gotUrlParams(false,'https://wr.io/1234567800/Hello/index.html','Hello/index.html'));
    const s2 = reducer(s1,receiveUserData({wrioID:'1234567800'}));
