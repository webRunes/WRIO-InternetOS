...
describe("LS+JSON tests test", () => {
  test("Should be able to import document and convert it back to JSON", () => {
    ...
    const j = s2.editorDocument.document.draftToJson(
  ...
  test("should be able to create new document, import image and convert it to JSON", () => {
    ...
    let s2 = reducer(
      s1,
      createNewImage("Hello", "https://sample.host/catty1.jpg", "image 1")
    );
    s2 = reducer(
      s2,
      createNewImage("Hello", "https://sample.host/catty2.jpg", "image 2")
    );
    s2 = reducer(
      s2,
      createNewLink("Link", "https://sample.host/catty.html", "link")
    );
