...
function insertBlockAfterKey(
  blockMap: BlockMap,
  key: string,
  blocksToInsert: Array<ContentBlock>
) {
  let wasInserted = false;
  const injectBlocks = blocks =>
    blocksToInsert.reduce((acc, _block) => acc.set(_block.key, _block), blocks);
...
export default function insertAtomicBlock(
  editorState,
  entityKey,
  character,
  afterKey,
