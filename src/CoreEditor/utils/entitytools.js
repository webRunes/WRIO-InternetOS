...
import TicketEntity from '../EditorEntities/TicketEntity'
...
export default class EntityTools {
  ...
  /**
     * Creates external ticket entity
     * @param url
     * @param description
     * @param title
     * @returns {urlType}
     */
static createTicketEntity(
      url: string,
      description: string,
      title: string,
      image: string,
    ) {
      const urlType = "TICKET"
      const entityKey = Entity.create(urlType, "IMMUTABLE", {
        src: url,
        description,
        title,
...
/**
     * Inserts external ticket into editorState from metablock generated by LDJSONDocument
     * @param editorState - prev editorState
     * @param metaBlock
     * @returns {*} new editorState
     */
...
export const findTicketEntities = findEntitiesOfType("TICKET");
...
export const customDecorators = [
  ...
  {
    strategy: findTicketEntities,
    component: TicketEntity,
  },
];
...
export function createNewTicket(
  ...
  const entityKey = EntityTools.createTicketEntity(
    url,
    description,
    title,
    image,
