...
class PostSettings extends React.Component {
    ...
    render () {
        ...
        return (<div>
          ...
          {this.props.createMode && <div className={className}>
            ...
            <CommentEnabler isChecked={this.props.commentsEnabled}
            ...
            {this.props.alert && <Modal  onCancel={() => this.setState({alert: false})}
