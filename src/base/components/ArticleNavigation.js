...
const MenuButton = ({
  ...
  const className = active ? "active" : "",
    click = () => onNavigateArticleHash(name, replaceSpaces(name)),
...
const UpButton = ({ showUp }) => {
  return (
    ...
    >
      {showUp && (
        <i className="material-icons dp_big invert-icon-v visib2le-xs-block">
          file_download
        </i>
      )}
    </a>
  ...
  render() {
    ...
    return (
      <nav
        ...
        className={
          !vertical ? "contents visible-md-block visible-lg-block" : ""
        }
      >
  ...
  render() {
    return (
      <div ref="container" className="col-sm-3">
        <div ref="subcontainer" id="sidebar">
