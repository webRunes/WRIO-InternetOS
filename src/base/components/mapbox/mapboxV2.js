...
class MapBox extends React.Component {
  ...
  static mapOnClick(cordinates, description,sensorProductName,checkEnable) {// for popup
    ...
    if(checkEnable == "enable"){
      text = "<div>"+'<p>'+ProductName+'</p>'+"<p>"+Description+'</p>'+'<p>'+filteredGeoCoordinates+'</p>+</div>';
    }else{
      text = "<div id='para1'>"+'<p>'+ProductName+'</p>'+"<p>"+Description+'</p>'+'<p>'+filteredGeoCoordinates+'</p>+</div>';
    }
